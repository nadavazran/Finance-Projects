...
# -*- coding: utf-8 -*-
"""
Created on Sat Sep 28 15:16:49 2024
...
tickers = ['SPY', 'LULU', 'GD', 'DVN', 'BSX', 'WMT', 'FCX', 'PANW','AAPL']
...
aapl  = AAPL['pct'].to_numpy(); aapl = np.delete(panw, 0)
...
#  Do linear regression calculating the slope (beta) and correlation (stored in r_value)
slope, intercept, r_value, p_value, std_err =  linregress(aapl, spy)
...
data = [SPY['pct'], LULU['pct'], GD['pct'], DVN['pct'], BSX['pct'], WMT['pct'],  FCX['pct'], PANW['pct'], AAPL['pct']]
